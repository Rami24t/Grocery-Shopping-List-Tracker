  ...
  return (
    ...
    >
      <BsPencil
        ...
        className={`block m-2 text-center hover:font-bold hover:scale-110 focus:font-bold focus:scale-110 active:scale-110  text-2xl transition-transform duration-200 ${
          darkMode
