  ...
  function EditButton() {
    return (
      <button
        type="button"
        onClick={handleEdit}
        className={`leading-none w-6 h-6 rounded-lg m-2 text-center border hover:font-bold text-xl focus:ring-4 focus:outline-none  ${dark?'border-indigo-400 bg-indigo-950 text-indigo-300 focus:ring-indigo-700 hover:text-indigo-200 hover:border-indigo-300': ' text-slate-800 hover:text-slate-600   border-slate-600 focus:ring-slate-400 '}`}
  ...
  function DeleteButton() {
    return (
      <button
        ...
        type="button"
        className={`inline-flex items-center justify-center w-6 h-6 leading-none rounded-lg ml-3 m-2 text-center hover:border-red-500 hover:font-bold text-xl border focus:ring-4 focus:outline-none ${dark?'border-red-600 hover:border-red-400 text-red-500 bg-red-950  focus:ring-red-900 hover:text-red-400':' text-red-700 hover:text-red-500 border-red-700 focus:ring-red-300'} `}
