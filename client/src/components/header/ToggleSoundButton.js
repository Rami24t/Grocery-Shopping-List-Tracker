...
function ToggleSoundButton({ handleClick, darkMode, sound = true }) {
  ...
  ${
    !darkMode
      ? "hover:bg-gray-100 hover:text-blue-800 text-blue-600 bg-gray-100 border-gray-200 focus:ring-gray-300"
          ...
          <div
            className={`m-0 p-0 w-2 h-4 peer-focus:outline-none peer-focus:ring-2 rounded-full peer ${
              darkMode
                ...
                : "peer-focus:ring-blue-300 after:bg-white bg-gray-100 border-gray-200 focus:ring-gray-300 peer-checked:bg-blue-500"
            } peer-checked:after:-translate-y-[120%] after:content-[''] after:absolute after:-bottom-[10%] after:left-[-1px] after:border after:rounded-full after:h-2 after:w-2 after:transition-transform`}
          ></div>
        </label>
      </button>
  );
