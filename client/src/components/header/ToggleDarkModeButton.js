...
function ToggleDarkModeButton({ darkMode, handleClick }) {
  ...
  return  <>
  <button onClick={handleClick} type="button" class={`-mt-11 float-right ml-3 px-1 cursor-pointer flex items-center w-9 h-9 justify-center text-xs font-medium border rounded-lg toggle-dark-state-example focus:z-10 focus:ring-2 focus:outline-none 
  ...
  "focus:ring-gray-500 bg-gray-800 text-gray-400 border-gray-700 hover:text-gray-100 hover:bg-gray-700"}`}>
    ...
    <label className="relative ml-1 inline-flex items-center cursor-pointer">
            ...
            <div
              ...
              } peer-checked:after:-translate-y-[120%] peer-checked:after:border-white after:content-[''] after:absolute after:-bottom-[10%] after:left-[-1px]  after:border-gray-400 after:border after:rounded-full after:h-2 after:w-2 after:transition-all peer-checked:bg-blue-500
                ${!darkMode?"after:bg-white bg-gray-100 border-gray-200 focus:ring-gray-300": 
